...
| `ca_scientist_noise` | bool | false | If CASSIE should make the default noises a ClassD escapes. |
| `ca_scientist_escape` | string |  | Announcement that will be played when a Scientist escapes. |
| `ca_scientist_noise` | bool | false | If CASSIE should make the default noises a Scientist escapes. |
